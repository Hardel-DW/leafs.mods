...
@Pseudo
@Mixin(targets = {
    // LootrMinecraft/Lootr, tickers per dimension, created by chunk loads from any thread and walked by the server tick.
    "noobanidus.mods.lootr.common.block.entity.BlockEntityTicker"
})
public abstract class StaticObject2ObjectMapMixin {
