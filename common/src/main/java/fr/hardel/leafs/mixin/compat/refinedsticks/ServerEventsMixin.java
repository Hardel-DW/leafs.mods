package fr.hardel.leafs.mixin.compat.refinedsticks;
...
/** benbenlaw/refinedsticks, per player positions. Every player tick writes the map from the player's region. */
@Pseudo
@Mixin(targets = "com.benbenlaw.refinedsticks.event.ServerEvents")
