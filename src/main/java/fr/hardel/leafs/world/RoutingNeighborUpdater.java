...
/**
 * {@code Level.neighborUpdater} swap: the collector is a reentrancy stack of the current execution,
 * so it resolves by tick context, never by position. Off-tick callers keep the level instance.
 */
