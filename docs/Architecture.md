...
3. Les workers de chunks. Ce pool, réglé par `chunk_threads`, exécute la progression de génération et les lectures disque des chunks, plusieurs chunks à la fois par dimension. Les étapes de génération qui traversent les frontières de chunks s'excluent spatialement entre elles, les autres tournent librement.
