...
L'envoi des chunks aux clients appartient à la région du joueur. À chaque tick, la région calcule le diff de vue de ses joueurs, sérialise les chunks à envoyer et les met en file sur le canal, et le thread global ne fait que flusher à sa cadence. Une région ne sérialise que les chunks qu'elle possède, ce qui garantit qu'aucun chunk n'est lu pendant qu'un autre thread l'écrit. Un chunk en attente qui appartient à une autre région reste en attente et part quand la propriété converge. Le tampon des chunks à envoyer de chaque joueur est concurrent, parce que la phase sérielle y marque les chunks fraîchement prêts pendant que la région envoie.
